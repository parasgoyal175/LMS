  ...
  return (
    <div className='flex items-center justify-between h-[70px] shadow-lg px-[22px]'>
        <div className='flex items-center rounded-[5px] shadow-md'>
            <input type="text" name="" className='bg-[#F8F9FC h-[40px] outline-none pl-[13px] w-[350px] rounded-[5px] placeholder:text-[14px] leading-[20px] font-normal' placeholder='Search For...'/>
